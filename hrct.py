...
class Ui_HRCT(object):
    def setupUi(self, HRCT):
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(770, 140, 131, 38))
        self.layoutWidget5.setObjectName("layoutWidget5")
        self.ggovalue_layout = QtWidgets.QVBoxLayout(self.layoutWidget5)
        self.ggovalue_layout.setContentsMargins(0, 0, 0, 0)
        self.ggovalue_layout.setObjectName("ggovalue_layout")
        self.cggo_value = QtWidgets.QLabel(self.layoutWidget5)
        self.cggo_value.setObjectName("cggo_value")
        self.ggovalue_layout.addWidget(self.cggo_value)
        self.ggo_value = QtWidgets.QLabel(self.layoutWidget5)
