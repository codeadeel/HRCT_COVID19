...
class Ui_HRCT(object):
    def setupUi(self, HRCT):
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(510, 140, 251, 38))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(770, 140, 131, 38))
        ...
        self.widget.setGeometry(QtCore.QRect(11, 240, 951, 40))
    ...
    def loader_clicker(self, clicker):
        ...
        if self.clicker_ready == True:
            ...
            if (self.total_ggo*self.multi_factor)>=50:
                ...
                self.ggo_value.setText(_translate("Dialog", '{:.8f} %'.format(self.total_ggo * self.multi_factor)))
