...
class scan:
    ...
    def __load_slices__(self):
        ...
        Slices files
        '''
        slice_files = [pydicom.read_file(f'{self.address}/{i}') for i in os.listdir(self.address)]
        slice_files.sort(key = lambda i: int(i.ImagePositionPatient[2]), reverse=True)
        try:
...
class Ui_HRCT(object):
    def setupUi(self, HRCT):
        ...
        self.layoutWidget = QtWidgets.QWidget(HRCT)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 491, 57))
        self.layoutWidget.setObjectName("layoutWidget")
        self.mainheader1 = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.mainheader1.setContentsMargins(0, 0, 0, 0)
        self.mainheader1.setObjectName("mainheader1")
        self.header1 = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        ...
        self.layoutWidget1 = QtWidgets.QWidget(HRCT)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 80, 491, 46))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.homedirectory = QtWidgets.QVBoxLayout(self.layoutWidget1)
        self.homedirectory.setContentsMargins(0, 0, 0, 0)
        self.homedirectory.setObjectName("homedirectory")
        self.instruct2 = QtWidgets.QLabel(self.layoutWidget1)
        self.instruct2.setObjectName("instruct2")
        self.homedirectory.addWidget(self.instruct2)
        self.gethomedir = QtWidgets.QLineEdit(self.layoutWidget1)
        self.gethomedir.setObjectName("gethomedir")
        self.homedirectory.addWidget(self.gethomedir)
        self.layoutWidget2 = QtWidgets.QWidget(HRCT)
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 190, 951, 46))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.loaderbar1 = QtWidgets.QVBoxLayout(self.layoutWidget2)
        self.loaderbar1.setContentsMargins(0, 0, 0, 0)
        self.loaderbar1.setObjectName("loaderbar1")
        self.loaderlabel = QtWidgets.QLabel(self.layoutWidget2)
        self.loaderlabel.setObjectName("loaderlabel")
        self.loaderbar1.addWidget(self.loaderlabel)
        self.loaderprogress = QtWidgets.QProgressBar(self.layoutWidget2)
        ...
        self.layoutWidget3 = QtWidgets.QWidget(HRCT)
        self.layoutWidget3.setGeometry(QtCore.QRect(530, 120, 251, 59))
        self.layoutWidget3.setObjectName("layoutWidget3")
        self.ggolabel_layout = QtWidgets.QVBoxLayout(self.layoutWidget3)
        self.ggolabel_layout.setContentsMargins(0, 0, 0, 0)
        self.ggolabel_layout.setObjectName("ggolabel_layout")
        self.corad_label = QtWidgets.QLabel(self.layoutWidget3)
        self.corad_label.setObjectName("corad_label")
        self.ggolabel_layout.addWidget(self.corad_label)
        self.cggo_label = QtWidgets.QLabel(self.layoutWidget3)
        self.cggo_label.setObjectName("cggo_label")
        self.ggolabel_layout.addWidget(self.cggo_label)
        self.ggo_label = QtWidgets.QLabel(self.layoutWidget3)
        self.ggo_label.setObjectName("ggo_label")
        self.ggolabel_layout.addWidget(self.ggo_label)
        self.layoutWidget4 = QtWidgets.QWidget(HRCT)
        self.layoutWidget4.setGeometry(QtCore.QRect(800, 120, 131, 59))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.ggovalue_layout = QtWidgets.QVBoxLayout(self.layoutWidget4)
        self.ggovalue_layout.setContentsMargins(0, 0, 0, 0)
        self.ggovalue_layout.setObjectName("ggovalue_layout")
        self.corad_value = QtWidgets.QLabel(self.layoutWidget4)
        self.corad_value.setObjectName("corad_value")
        self.ggovalue_layout.addWidget(self.corad_value)
        self.cggo_value = QtWidgets.QLabel(self.layoutWidget4)
        self.cggo_value.setObjectName("cggo_value")
        self.ggovalue_layout.addWidget(self.cggo_value)
        self.ggo_value = QtWidgets.QLabel(self.layoutWidget4)
        self.ggo_value.setObjectName("ggo_value")
        self.ggovalue_layout.addWidget(self.ggo_value)
        self.layoutWidget5 = QtWidgets.QWidget(HRCT)
        self.layoutWidget5.setGeometry(QtCore.QRect(11, 240, 951, 40))
        ...
        self.viewerlabel1 = QtWidgets.QLabel(self.layoutWidget5)
        self.viewerlabel1.setObjectName("viewerlabel1")
        self.horizontalLayout.addWidget(self.viewerlabel1)
        self.sample_num = QtWidgets.QLabel(self.layoutWidget5)
        self.sample_num.setObjectName("sample_num")
        self.horizontalLayout.addWidget(self.sample_num)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.slider1 = QtWidgets.QSlider(self.layoutWidget5)
        self.slider1.setOrientation(QtCore.Qt.Horizontal)
        self.slider1.setObjectName("slider1")
        self.verticalLayout.addWidget(self.slider1)
        self.div2 = QtWidgets.QFrame(HRCT)
        self.div2.setGeometry(QtCore.QRect(510, 10, 16, 171))
        self.div2.setFrameShape(QtWidgets.QFrame.VLine)
        self.div2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.div2.setObjectName("div2")
        self.line = QtWidgets.QFrame(HRCT)
        self.line.setGeometry(QtCore.QRect(660, 10, 16, 101))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.widget = QtWidgets.QWidget(HRCT)
        self.widget.setGeometry(QtCore.QRect(530, 10, 123, 103))
        self.widget.setObjectName("widget")
        self.corad_scale = QtWidgets.QVBoxLayout(self.widget)
        self.corad_scale.setContentsMargins(0, 0, 0, 0)
        self.corad_scale.setObjectName("corad_scale")
        self.corad_header = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.corad_header.setFont(font)
        self.corad_header.setObjectName("corad_header")
        self.corad_scale.addWidget(self.corad_header)
        self.corad_mild = QtWidgets.QLabel(self.widget)
        self.corad_mild.setObjectName("corad_mild")
        self.corad_scale.addWidget(self.corad_mild)
        self.corad_moderate = QtWidgets.QLabel(self.widget)
        self.corad_moderate.setObjectName("corad_moderate")
        self.corad_scale.addWidget(self.corad_moderate)
        self.corad_severe = QtWidgets.QLabel(self.widget)
        self.corad_severe.setObjectName("corad_severe")
        self.corad_scale.addWidget(self.corad_severe)
        self.corad_critical = QtWidgets.QLabel(self.widget)
        self.corad_critical.setObjectName("corad_critical")
        self.corad_scale.addWidget(self.corad_critical)
    ...
    def retranslateUi(self, HRCT):
        ...
        HRCT.setWindowTitle(_translate("HRCT", "HRCT COVID-19"))
        ...
        self.corad_label.setText(_translate("HRCT", "CORADS Score:"))
        self.cggo_label.setText(_translate("HRCT", "Current Sample Ground Glass Opacity:"))
        self.ggo_label.setText(_translate("HRCT", "Ground Glass Opacity:"))
        self.corad_value.setText(_translate("HRCT", "Null"))
        self.cggo_value.setText(_translate("HRCT", "Null"))
        self.ggo_value.setText(_translate("HRCT", "Null"))
        self.viewerlabel1.setText(_translate("HRCT", "Sample Viewer"))
        self.sample_num.setText(_translate("HRCT", "Sample Number: 0/0"))
        self.corad_header.setText(_translate("HRCT", "CORADS Scale"))
        self.corad_mild.setText(_translate("HRCT", "Mild ( 1 - 10 )"))
        self.corad_moderate.setText(_translate("HRCT", "Moderate ( 11 - 20 )"))
        self.corad_severe.setText(_translate("HRCT", "Severe ( 21 - 30 )"))
        self.corad_critical.setText(_translate("HRCT", "Critical ( 31 - 40 )"))
        self.starter()
    ...
    def loader_clicker(self, clicker):
        ...
        if self.clicker_ready == True:
            ...
            _translate = QtCore.QCoreApplication.translate
            if (self.total_ggo*self.multi_factor)>=50:
                updated_ggo = self.total_ggo
                self.ggo_value.setText(_translate("Dialog", '{:.8f} %'.format(updated_ggo)))
            else:
                updated_ggo = self.total_ggo * self.multi_factor
                self.ggo_value.setText(_translate("Dialog", '{:.8f} %'.format(updated_ggo)))
            self.ggo_value.setStyleSheet("color: red;")
            self.compute_corads = updated_ggo * 0.4
            self.corad_value.setText(_translate("Dialog", '{:.8f}'.format(self.compute_corads)))
            self.corad_value.setStyleSheet("color: red;")
            if (self.compute_corads >=0 and self.compute_corads <=10):
                self.corad_mild.setStyleSheet("color: green;")
            if (self.compute_corads >=11 and self.compute_corads <=20):
                self.corad_moderate.setStyleSheet("color: yellow;")
            if (self.compute_corads >=21 and self.compute_corads <=30):
                self.corad_severe.setStyleSheet("color: orange;")
            if (self.compute_corads >=31 and self.compute_corads <=40):
                self.corad_critical.setStyleSheet("color: red;")
    ...
    def slider_changer(self, val1):
        ...
        if self.img_data_available == True:
            ...
            ax7.axis('off')
            ax8.axis('off')
            self.sample_num.setText(_translate("Dialog", 'Sample Number: {}/{}'.format(val1+1, len(self.current_scan.scan_stack))))
            self.cggo_value.setText(_translate("Dialog", '{:.8f} %'.format(area1)))
            self.cggo_value.setStyleSheet("color: red;")
            self.canvas.draw()
    ...
    def reseter1(self, clicker):
        ...
        self.cggo_value.setText(_translate("Dialog", "Null"))
        self.cggo_value.setStyleSheet("color: black;")
        self.sample_num.setText(_translate("HRCT", "Sample Number: 0/0"))
        self.corad_mild.setStyleSheet("color: black;")
        self.corad_moderate.setStyleSheet("color: black;")
        self.corad_severe.setStyleSheet("color: black;")
        self.corad_critical.setStyleSheet("color: black;")
        self.corad_value.setText(_translate("Dialog", "Null"))
        self.corad_value.setStyleSheet("color: black;")
        self.sample_ggo = list()
